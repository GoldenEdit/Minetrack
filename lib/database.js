...
const { ONE_WEEK, TimeTracker } = require('./time')
...
class Database {
  ...
  deleteOldPings (callback) {
    ...
    // An extra week is retained so the historical graph can be compared against the same time last week
    const oldestTimestamp = TimeTracker.getEpochMillis() - config.graphDuration - ONE_WEEK
